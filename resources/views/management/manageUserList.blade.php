        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="page-content" style="min-height:602px">
                    ...
                    <h3 class="page-title">
                        Management
                        <small>Management User List</small>
                    </h3>
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="/hrm_demo/admin/employees">Management User</a>
                                <i class="fa fa-angle-right"></i>
                            </li>
                            <li>
                                <a href="#">Management User List</a>
                            </li>
                        </ul>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <a id="managementUserCreate" href="#" class="btn green">
                                Add New Management User <i class="fa fa-user-plus"></i>
                            </a>
                            <script>
                                $('#managementUserCreate').click(function () {
                                    $('.content-wrapper:eq(0)').load('{{ route('managementUser.create') }}');
