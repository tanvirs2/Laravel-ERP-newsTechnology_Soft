            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="page-content" style="min-height:602px">
                        ...
                        <!-- BEGIN PAGE HEADER-->
                        <h3 class="page-title">
                            <span class="fa fa-plus"></span>    New Management User
                        </h3>
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="/hrm_demo/admin/Management Users">Management Users</a>
                                    <i class="fa fa-angle-right"></i>
                                </li>
                                <li>
                                    <a href="#">New Management User</a>
                                </li>
                            </ul>
                        </div>
                        <!-- END PAGE HEADER-->
                        ...
                        @else
                            ...
                            <form action="{{ route('managementUser.store') }}" method="POST"  accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data" id="Management UserCreate">
                                {{ csrf_field() }}
                                <div class="row ">
                                            ...
                                            <div class="portlet-body">
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control" name="fullName" placeholder="Management User Name" value="{{ Input::old('fullName') }}">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="portlet box red-sunglo">
                                            ...
                                            <div class="portlet-body">
                                                ...
                                                <div class="form-body">
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label">Management User ID<span class="required">* </span></label>
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control" name="employeeID" placeholder="Management User ID" value="{{Input::old('employeeID')}}">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
