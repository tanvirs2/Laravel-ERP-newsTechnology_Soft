        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-circle" src="{{ asset('') }}assets/img/{{ Auth::user()->avatar }}" alt="User profile picture">
              ...
              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                    <label class="btn btn-success btn-block">
                        Upload Image <input name="avatar" type="file" style="display: none;">
                    </label>
                </li>
                <li class="list-group-item">
                ...
                <li class="list-group-item">
                    <input type="text" name="designation" class="form-control" placeholder="Designation" value="{{ Auth::user()->designation }}">
                </li>
              </ul>
                    ...
                    <div class="col-sm-6">
                      <div class="row">
                        <div class="col-sm-6">
                          ...
                          <br>
                          <img class="img-responsive" src="{{ asset('') }}assets/dist/img/photo3.jpg" alt="Photo">
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                          <img class="img-responsive" src="{{ asset('') }}assets/dist/img/photo4.jpg" alt="Photo">
                          <br>
                          <img class="img-responsive" src="{{ asset('') }}assets/dist/img/photo1.png" alt="Photo">
                        </div>
                        <!-- /.col -->
