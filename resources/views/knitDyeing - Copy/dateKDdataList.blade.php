...
@section('content')
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="page-content" style="min-height:602px">
                        ...
                        <h3 class="page-title">
                            Knitting & Dyeing
                            <small>Knitting & Dyeing Report</small>
                        </h3>
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="/hrm_demo/admin/employees">Knitting & Dyeing</a>
                                    <i class="fa fa-angle-right"></i>
                                </li>
                                <li>
                                    <a href="#">Date wise Knitting & Dyeing</a>
                                </li>
                            </ul>
                        </div>
                        <!-- END PAGE HEADER-->
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet box blue">
                                    ...
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-street-view"></i>Date Wise Knitting & Dyeing
                                        </div>
                                        <div class="tools">
                                        </div>
                                    </div>
                                        ...
                                        <div id="sample_employees_wrapper" class="dataTables_wrapper no-footer">
                                            <div class="table-scrollable" id="table-scrollable">
                                                <table class="table table-striped table-bordered table-hover dataTable no-footer" id="shpmntTable" role="grid" aria-describedby="sample_employees_info">
                                                    ...
                                                    <tr role="row">
                                                        <th style="text-align: center; width: 50px;" class="sorting"
                                                    ...
                                                    @include("knitDyeing.dateKDtable")
                                                </table>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
            ...
            function libSearch(selector, field) {
                $(selector).autocomplete({
                    source: function (request, response) {
                        ...
                        var getNameURL = "{{ url('productionEEE/dateAutoCompltSrch')}}/" + field + "/" + DTO.terms;
                        $.ajax({
                            data: DTO,
                            global: false,
                            type: "GET",
                    ...
                    select: function( event, ui ) {
                        ...
                        var getActionURL = "{{ url('productionTTT/dateAutoCompltRslt')}}/" + field + "/" + name;
                        $.ajax({
                            cache: false,
                            global: false,
                            url: getActionURL,
        ...
        $("#fromToSearch").click(function () {
            ...
            var url = "{{ url('knitAndDyeing/kdDatePageSearchDateRange/:from/:to')}}";
