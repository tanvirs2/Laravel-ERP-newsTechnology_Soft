        ...
        <div class="box">
            <div class="box-body">
                <div class="page-content" style="min-height:602px">
                    ...
                    <form id="prCreate" action="{{ route('knitDying.update', $knitDyeing->id) }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class="portlet-body">
                                        <div class="form-body">
                                            <span id="orderDetails">
                                                <input type="hidden" class="form-control" name="KD[order_id]" value="{{ $knitDyeing->order_id }}">
                                                    <div class="form-group">
                                                        <label id="" class="col-md-3 control-label">Date <span class="required">* </span></label>
                                                        <div class="col-md-9">

                                                            <input type="text" class="dPick form-control" name="KD[date]" value="{{ $knitDyeing->date }}" placeholder=""  autocomplete="off" >
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control" name="KD[color]" value="{{ $knitDyeing->color }}" placeholder="" >
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control" name="KD[grmntQTY]" value="{{ $knitDyeing->grmntQTY }}" placeholder="" >
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control" name="KD[colorYarnRqrd]" value="{{ $knitDyeing->colorYarnRqrd }}" placeholder="">
                                                            <input type="hidden" class="form-control subConNm" name="" >
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control" name="KD[yarnIss]" value="{{ $knitDyeing->yarnIss }}" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label">KnitQTY</label>
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control" name="KD[kntQty]" value="{{ $knitDyeing->kntQty }}" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label">DyeingQTY</label>
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control" name="KD[dyeingQty]" value="{{ $knitDyeing->dyeingQty }}" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label">FinishFabRqrd</label>
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control" name="KD[fnshFabRqrd]" value="{{ $knitDyeing->fnshFabRqrd }}" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label">FinishFabRcv</label>
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control" name="KD[fnshFabRcv]" value="{{ $knitDyeing->fnshFabRcv }}" placeholder="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            <button id="" type="submit" data-loading-text="Submitting..." class="demo-loading-btn btn green">
                                                                <i class="fa fa-plus"></i>	Update Knit Dyeing Inf
                                                            </button>
                                                        </div>
                                                    </div>
