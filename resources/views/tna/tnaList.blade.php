                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box blue">
                                ...
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-street-view"></i>TNA
                                    </div>
                                    <div class="tools">
                                    </div>
                                </div>
                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="">
                                        <span class="text-center"><button class="print btn btn-success">PrintSheet</button>
                                            ...
                                            <table class="table table-striped table-bordered table-hover dataTable no-footer" id="shpmntTable" role="grid" aria-describedby="sample_employees_info">
                                                ...
                                                <tr role="row">
                                                    ...
                                                    <th class="text-center sorting_disabled" rowspan="1" colspan="1" style="" aria-label="Action">
                                                        ...
                                                        <select style="color: black; width: 6em" class="" id="shipStsFrmTna" >
                                                    ...
                                                    <th class="text-center sorting" tabindex="0"
                                                        ...
                                                        style="" aria-label="
                                                            At Work
                                                            : activate to sort column ascending">
                                                        Size Set/Fit Sample Submission
                                                        [Merchandiser]
                                                        <br>
                                                    </th>
                                                    <th class="text-center sorting" tabindex="0"
                                                    ...
                                                    <th class="text-center sorting" tabindex="0"
                                                        ...
                                                        style="" aria-label="
                                                            At Work
                                                            : activate to sort column ascending">
                                                        Receiving Fabric Shade Approval
                                                        [Fabric Responsible]
                                                        <br>
                                                    </th>
                                                    <th class="text-center sorting" tabindex="0"
                                                ...
                                                <tr role="row">
                                                    ...
                                                    <th>LdTime</th>
                                                    <th></th>
                                                    <th>Consumption calculation [Pattern Master] </th>
                                                    <th>Lab Dip Approval [Merchandiser]</th>
                                                    <th>Fabric Booking Generation [Merchandiser]</th>
                                                    <th>PO issue for Trims [Merchandiser]</th>
                                                    <th>Size Set/Fit Sample Submission [Merchandiser]</th>
                                                    <th>Seal/Approval of Sample [Merchandiser]</th>
                                                    ...
                                                    <th>Bulk Cutting [Cutting Manager]</th>
                                                    <th>Bulk Embroidery [Embroidery Responsible] </th>
                                                    <th>Bulk Printing [Printing Responsible] </th>
                                                    <th>Bulk Sewing [Production Manager] </th>
                                                    <th>Packing Complete [Finishing Manager]</th>
                                                    <th>Final Inspection [Quality Manager] </th>
                                                    <th>Ex-Factory [Finishing Manager] </th>
                                                    <th>Action</th>
                                                </tr>
                                                </thead>
                                                @include("tna.tnaTable")
                                            </table>
                                        </div>
                                    </div>
                                </div>
...
<script>
        ...
        function libSearch(selector, field) {
            $(selector).autocomplete({
                source: function (request, response) {
                    ...
                    var getNameURL = "{{ url('tna/autoCompltSrch')}}/" + field + "/" + DTO.terms;
                    $.ajax({
                        data: DTO,
                        global: false,
                        type: "GET",
    ...
    $("#fromToSearch").click(function () {
        ...
        var url = "{{ url('tna/searchDateRange/:from/:to/:byrNmeSrch/:shipSts')}}";
