...
@foreach ($employees as $employee)
    <tr class="orderRow" id="row{{ $employee->order_number }}" orderId="{{ $employee->order_number }}">
        ...
        <td class="text-center blackCol">
            <input type="type" class="" name="prDate" value="{{ date("Y-m-d") }}" style="width: 6em">
        </td>
        <td class="text-center blackCol">
            <input type="type" class="" name="prCut" value="" style="width: 6em">
        </td>
        <td class="text-center blackCol">
            <input type="type" class="" name="prSwIn" value="" style="width: 6em">
        </td>
        <td class="text-center blackCol">
            <input type="type" class="" name="prSwOut" value="" style="width: 6em">
        </td>
        <td class="text-center blackCol">
            <input type="type" class="" name="prIron" value="" style="width: 6em">
        </td>
        <td class="text-center blackCol">
            <input type="type" class="" name="prCarton" value="" style="width: 6em">
        </td>
        <td class="">
